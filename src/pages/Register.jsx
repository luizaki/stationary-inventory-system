...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-[#e1ffa7] flex flex-col justify-center py-6 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Or{' '}
          <Link to={`/login${next ? `?next=${encodeURIComponent(next)}` : ''}`} className="font-medium text-blue-600 hover:text-blue-500">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <form className="space-y-6" onSubmit={handleRegister}>
            ...
            <div>
              <label htmlFor="role" className="block text-left text-sm font-medium text-gray-700">
                Role
              </label>
              <div className="mt-1">
                <select
